...
urlpatterns = [
    ...
    path('topics/<int:topic_id>/create/', views.PostCreate.as_view(), name='posts_create'),
    ...
    path('topics/<int:topic_id>/<int:post_id>/create', views.CommentCreate.as_view(), name='comments_create'),
